...
TextButton_Roundify_4px_3.ImageColor3 = Color3.new(0, 0, 0)
...
TextButton_Roundify_4px_4.ImageColor3 = Color3.new(0, 0, 0)
...
TextButton_Roundify_4px_5.ImageColor3 = Color3.new(0, 0, 0)
			...
			function window_data:AddTab(tab_name)
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							v:GetChildren()[1].ImageColor3 = Color3.fromRGB(0, 0, 0)
					...
					new_button:GetChildren()[1].ImageColor3 = Color3.fromRGB(0, 0, 0)
